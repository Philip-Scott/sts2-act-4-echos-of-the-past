...
def launch(args):
    ...
    requires_snapshot = args.scenario not in ("ancient", "saved-run", "relic-art", "party", "party-layout")
...
def main():
    ...
    for scenario in ("loss", "nondefect", "poison", "ancient", "saved-run", "relic-art", "previews", "party", "party-layout"):
