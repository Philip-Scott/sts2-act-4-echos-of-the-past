...
def launch(args):
    ...
    requires_snapshot = args.scenario not in ("ancient", "saved-run", "relic-art", "attack-vfx")
...
def main():
    ...
    for scenario in ("loss", "nondefect", "poison", "ancient", "saved-run", "relic-art", "previews", "attack-vfx"):
