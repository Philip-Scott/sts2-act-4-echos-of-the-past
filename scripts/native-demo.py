...
def launch(args):
    ...
    requires_snapshot = args.scenario not in ("ancient", "saved-run", "relic-art", "party", "party-2", "party-3", "party-4", "party-layout", "attack-vfx", "deck-preview", "ending", "corruption")
...
def main():
    ...
    for scenario in ("loss", "nondefect", "poison", "ancient", "saved-run", "relic-art", "previews", "media", "party", "party-2", "party-3", "party-4", "party-layout", "attack-vfx", "deck-preview", "ending", "corruption"):
